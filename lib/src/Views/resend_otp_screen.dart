...
import '../SplashScreenFolder/otp_verified_screen.dart';

class ResendOtpScreen extends StatefulWidget {
  const ResendOtpScreen({super.key});

  @override
  State<ResendOtpScreen> createState() => _OtpVerifyScreenState();
}

class _OtpVerifyScreenState extends State<ResendOtpScreen> {
  @override
